...
Fate не має стандартного сетингу, але найкраще працює за будь-якої передумови, де персонажі є проактивними, здібними людьми, що ведуть драматичне життя. Більше порад про це можна знайти в розділі [[fate-core/game-creation]].
