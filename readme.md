...
5. **Форматування тексту**:
   ...
   - Заповнювачі (fill-in-the-blank): в оригіналі позначені `____`, перекладаємо як **жирні** описові слова: **аспект**, **ситуація**, **ускладнення** тощо. Не використовувати підкреслення — kramdown інтерпретує їх як маркери bold/italic.
...
| Event-based Compel        | Aspects and Fate Points             | Зовнішня спонука                | Світ реагує на аспект і створює ускладнення. От халепа.                      |
| Decision-based Compel     | Aspects and Fate Points             | Внутрішня спонука               | Персонаж приймає рішення через аспект, і все йде не так                      |
| Damn your luck            | Aspects and Fate Points             | От халепа                        | Фінальна фраза формули зовнішньої спонуки                                   |
